    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_time', models.DateTimeField(auto_created=True, verbose_name='updated time')),
                ('created_time', models.DateTimeField(auto_created=True, verbose_name='created time')),
                ('title', models.CharField(max_length=50, verbose_name='title')),
                ('describtion', models.TextField(blank=True, verbose_name='description')),
